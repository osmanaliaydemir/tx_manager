...
abstract class AppLocalizations {
  ...
  /// Subtitle text shown on the login screen
  ///
  /// In en, this message translates to:
  ...
  /// Subtitle for the first step of onboarding
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Build Authority'**
  String get goalAuthority;

  /// Goal option: Engagement
  ///
  /// In en, this message translates to:
  /// **'Spark Conversation'**
  String get goalEngagement;

  /// Goal option: Community
  ///
  /// In en, this message translates to:
  /// **'Build Community'**
  String get goalCommunity;
